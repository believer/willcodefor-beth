...
export async function postsIndex(c: C<'/posts'>) {
  ...
  if (query.search) {
    ...
    return c.html(<Posts posts={data} search={query.search as string} />)
  }
  ...
  if (query?.sort === 'views') {
    ...
    return c.html(<Posts posts={data} sort="views" />)
  }
  ...
  return c.html(<Posts posts={data} sort={query.sort as Sort} />)
}
